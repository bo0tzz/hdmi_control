defmodule MatrixControllerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(MatrixControllerWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(MatrixControllerWeb.Gettext, "errors", msg, opts)
    # end
