defmodule LeafHdmiMatrix.Protocol.Framing do
  @behaviour Circuits.UART.Framing

  @moduledoc """
  Each message is 3 bytes. This framer doesn't do anything for the transmit
  direction, but for receives, it will collect bytes in batches of 3 before
  ...
  Copied basically verbatim from Circuits.UART.Framing.FourByte
  """
  ...
  defp process_data(<<message::binary-size(3), rest::binary>>, messages) do
